                    ...
                    return (
                      <tr key={c.id}>
                        ...
                        <td style={tdStyle}>
                          ...
                          <div style={{ fontSize: '12px', color: 'var(--muted-foreground)' }}>{c.mail_templates?.name ?? '—'}</div>
                        </td>
                        <td style={tdStyle}><ProgressBar value={done} total={c.total_recipients} /></td>
                        <td style={tdStyle}>{c.open_count} <span style={{ color: 'var(--muted-foreground)' }}>({percent(c.open_count, c.sent_count)})</span></td>
                        <td style={tdStyle}>{c.reply_count} <span style={{ color: 'var(--muted-foreground)' }}>({percent(c.reply_count, c.sent_count)})</span></td>
