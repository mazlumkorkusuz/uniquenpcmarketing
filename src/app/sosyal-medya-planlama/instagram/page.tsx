...
export default async function InstagramPlanlama() {
  ...
  return (
    <div>
      <PageHeader
        title="Instagram Planlaması"
        subtitle={`${total} gönderi planlandı`}
        icon={Camera}
        gradient={`linear-gradient(135deg, ${COLOR}, #833ab4)`}
      />
      <div style={{ padding: '24px 32px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '16px', marginBottom: '28px' }}>
          <StatCard label="Toplam Gönderi"  value={total}          icon={Camera}      iconColor={COLOR}    iconBg={`${tint(COLOR, 13)}`} />
