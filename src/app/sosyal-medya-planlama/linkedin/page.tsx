...
export default async function LinkedinPlanlama() {
    ...
    <div>
      ...
      <div style={{ padding: '24px 32px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(200px, 1fr))', gap: '16px', marginBottom: '28px' }}>
          <StatCard label="Toplam Gönderi"  value={total}          icon={Briefcase}   iconColor={COLOR}    iconBg={`${tint(COLOR, 13)}`} />
