...
const navItems: NavItem[] = [
  ...
  {
    href: '/sosyal-medya-planlama',
    label: 'Sosyal Medya Planlaması',
    icon: CalendarCheck,
    children: [
      { href: '/sosyal-medya-planlama/tiktok',    label: 'TikTok' },
      { href: '/sosyal-medya-planlama/instagram', label: 'Instagram' },
      { href: '/sosyal-medya-planlama/twitter',   label: 'Twitter' },
      { href: '/sosyal-medya-planlama/linkedin',  label: 'LinkedIn' },
      { href: '/sosyal-medya-planlama/youtube',   label: 'YouTube' },
      { href: '/sosyal-medya-planlama/reddit',    label: 'Reddit' },
      { href: '/sosyal-medya-planlama/ig',        label: 'IG' },
    ],
  },
